...
os.environ['PROJECT_NAME'] = 'Cicada'
os.environ['PROJECT_NUMBER'] = this_version
os.environ['PROJECT_BRIEF_DESC'] = 'Project 8 Processed-Data File Format Library'
...
project = u'Cicada'
copyright = u'2018, Cicada Authors'
...
latex_documents = [
  (master_doc, 'Cicada.tex', u'Cicada Documentation',
...
texinfo_documents = [
  (master_doc, 'Cicada', 'Cicada Documentation',
   author, 'Cicada', 'Data file library for Project 8',
   'Miscellaneous'),
]
